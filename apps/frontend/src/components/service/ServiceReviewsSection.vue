...
const formRef = ref<InstanceType<typeof ServiceReviewForm> | null>(null);
...
const resolveTranslation = (review: ServiceReview) =>
    ...
    <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-start">
      <div>
        ...
        <p class="mt-3 max-w-2xl text-sm leading-6 text-gray-600 dark:text-gray-300">
          Phan hoi thuc te tu khach hang da su dung dich vu de ban tham khao truoc khi dat lich hoac yeu cau tu van.
        </p>
      </div>
    ...
    <div class="mt-8">
      ...
      >
        ...
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">
          Hay la nguoi dau tien chia se trai nghiem thuc te voi dich vu nay.
        </p>
      </div>
    </div>
